                ...
                <div class="container">
                    ...
                    <section class="invoice-list-wrapper section">
                        <div class="invoice-create-btn">
                            <a href="#modal2" class="btn waves-effect waves-light invoice-create border-round z-depth-4 modal-trigger">
                                <i class="material-icons">add</i>
                                <span class="hide-on-small-only">Create Categori</span>
                            </a>
                        </div>
                                ...
                                <tbody>
                                    @foreach($sertifikasis as $sertifikasi)
                                        <tr>
                                            ...
                                            <td></td>
                                            <td>
                                                <a href="app-invoice-view.html">{{$sertifikasi->name}}</a>
                                            </td>
